defmodule AudioConverter.Application do
  ...
  def start(_type, _args) do
    ...
    destination_directory =  Application.get_env(:audio_converter, :destination_directory)
    format =  Application.get_env(:audio_converter, :format)

    config = [opts: {source_directory,destination_directory,format}, latency: 0, watch_root: true]
